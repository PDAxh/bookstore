...
function createBookTable(data) {
    console.log(data);
    var bookTable = '<table class="table table-striped"><thead><tr><th scope="col">Title</th><th scope="col">Genre</th><th scope="col">Author</th><th scope="col">Published</th><th scope="col">Price</th><th>Rating</th><th scope="col">Inventory<th scope="col"><span class="glyphicon glyphicon-wrench" aria-hidden="true"></span></th><tr></thead><tbody>';
    ...
    for (var i = 0; i < responseObject.length; i++) {
        if (responseObject[i].id == id) {
            bookToPut = {
                ...
                "rating": responseObject[i].rating,
